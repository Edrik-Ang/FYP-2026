## test_steam.py covers Steam integration in two layers:
...
##      # 2. web-facing views (integration_views.py) via Django session-authenticated test client, with SteammService mocked out at the boundary os no network calls happen.
...
class SteamLinkViewTests(TestCase):
    ...
    @patch('identities.views.integration_views.SteamService.build_auth_url')
...
class SteamCallbackViewTests(TestCase):
    ...
    @patch('identities.views.integration_views.SteamService.link_steam_account')
    @patch('identities.views.integration_views.SteamService.verify_callback')
...
class SteamRefreshViewTests(TestCase):
    ...
    @patch('identities.views.integration_views.SteamService.refresh_player_data')
